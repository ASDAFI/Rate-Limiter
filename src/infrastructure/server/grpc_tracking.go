...
import (
	...
	"os/signal"
	"service/configs"
	"service/src/middlewares"
	server_rpc "service/src/proto/services/server"
	"syscall"
	"time"
)

func newRitalinServer() ServiceServer {
...
func RunInsecureGRPCServer() {
	...
	server_rpc.RegisterServerServer(grpcServer, &serviceServer)
